...
namespace Server
{
    public class Server
    {
        ...
        public static void Main(string[] args)
        {
            ...
            spawnData.PluginSearch.PluginTypes.Add(typeof(MongoDbConnector.MongoDbConnector));
            spawnData.PluginSearch.PluginTypes.Add(typeof(DatabaseProxy));
            spawnData.PluginSearch.PluginTypes.Add(typeof(Login));
            spawnData.PluginSearch.PluginTypes.Add(typeof(Chat));
            spawnData.PluginSearch.PluginTypes.Add(typeof(RoomSystem));
            ...
            //if (server.PluginManager.GetPluginByType<DatabaseProxy>().DataLayer == null)
            //{
